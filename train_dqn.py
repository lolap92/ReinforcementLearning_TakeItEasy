...
--no-tensorboard abschalten (z.B. wenn schon eins läuft).
...
def start_tensorboard(logdir, port=6006):
    ...
    TensorBoard, wird kein zweites gestartet, Chrome aber trotzdem geöffnet.
    Start über `sys.executable -m tensorboard` statt des blanken
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="TensorBoard nicht automatisch starten (Default: an, siehe "
             "Docstring oben). Sinnvoll wenn schon eins läuft.",
    )
    parser.add_argument(
